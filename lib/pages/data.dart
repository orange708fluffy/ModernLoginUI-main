  ...
  return <Book>[
    Book(
      ...
      Author(
        "Greer Hendricks",
        90,
        "lib/assets/authors/greer_hendricks.jpg",
      ),
      "4.14",
      "lib/assets/books/an_anonymous_girl_by_greer_hendricks.jpg",
    ),
    Book(
      "The Water Cure",
      ...
      Author(
        "Sophie Mackintosh",
        123,
        "lib/assets/authors/sophie_mackintosh.jpg",
      ),
      "4.14",
      "lib/assets/books/the_water_cure_by_sophie_mackintosh.jpg",
    ),
    Book(
      "The Dreamers",
      ...
      Author(
        "Karen Thompson",
        99,
        "lib/assets/authors/karen_thompson_walker.jpg",
      ),
      "4.14",
      "lib/assets/books/the_dreamers_by_karen_thompson.jpg",
    ),
    Book(
      "Maid",
      ...
      Author(
        "Stepanie Land",
        134,
        "lib/assets/authors/stepanie_land.jpg",
      ),
      "4.14",
      "lib/assets/books/maid_by_stepanie_land.jpg",
    ),
    Book(
      "The Suspect",
      ...
      Author(
        "Fiona Barton",
        87,
        "lib/assets/authors/fiona_barton.jpg",
      ),
      "4.14",
      "lib/assets/books/the_suspect_by_fiona_barton.jpg",
    ),
    Book(
      ...
      Author(
        "Pam Jenoff",
        108,
        "lib/assets/authors/pam_jenoff.jpg",
      ),
      "4.14",
      "lib/assets/books/the_lost_girls_of_paris_by_pam_jenoff.jpg",
    ),
    Book(
      "The Age of Light",
      ...
      Author(
        "Whitney Scharer",
        77,
        "lib/assets/authors/whitney_scharer.jpg",
      ),
      "4.14",
      "lib/assets/books/the_age_of_light_by_whitney_scharer.jpg",
    ),
    Book(
      "The Last Romantics",
      ...
      Author(
        "Tara Conklin",
        112,
        "lib/assets/authors/tara_conklin.jpg",
      ),
      "4.14",
      "lib/assets/books/the_last_romantics_by_tara_conklin.jpg",
    ),
    Book(
      "The Night Tiger",
      ...
      Author(
        "Yangsze Choo",
        65,
        "lib/assets/authors/yangsze_choo.jpg",
      ),
      "4.14",
      "lib/assets/books/the_night_tiger_by_yangsze_choo.jpg",
    ),
    Book(
      "The Lost Night",
      ...
      Author(
        "Andrea Bartz",
        75,
        "lib/assets/authors/andrea_bartz.jpg",
      ),
      "4.14",
      "lib/assets/books/the_lost_night_by_andrea_bartz.jpg",
    ),
    Book(
      ...
      Author(
        "Kristen Roupenian",
        70,
        "lib/assets/authors/kristen_roupenian.jpg",
      ),
      "4.14",
      "lib/assets/books/you_know_you_want_this_by_kristen_roupenian.jpg",
    ),
  ];
}
